...
public class GameManager : MonoBehaviour
{
    ...
    public void StartNewRun()
    {
        ...
        // Generate the hidden map structure
        runManager.GenerateMap();
    
        // Set initial node as current and mark as combat
        runManager.SetInitialNodeAsCurrent();
    
        // Load directly into combat
    ...
    // Add method to show appropriate UI based on state
    ...
    {
        if (postCombatUI != null)
            postCombatUI.SetActive(false);
        // Hide other UI panels as needed
    }

    private void ShowPostCombatUI()
    {
        if (postCombatUI != null)
        {
            postCombatUI.SetActive(true);
            // Get the component and initialize
            PostCombatUI ui = postCombatUI.GetComponent<PostCombatUI>();
            if (ui != null)
                ui.ShowRewards();
        }
    }
